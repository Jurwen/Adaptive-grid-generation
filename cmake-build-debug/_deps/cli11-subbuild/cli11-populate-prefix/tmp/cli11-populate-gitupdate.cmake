...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v2.3.2"
  WORKING_DIRECTORY "/Users/yiwenju/Dev/adaptive-mesh-refinement/cmake-build-debug/_deps/cli11-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/yiwenju/Dev/adaptive-mesh-refinement/cmake-build-debug/_deps/cli11-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/yiwenju/Dev/adaptive-mesh-refinement/cmake-build-debug/_deps/cli11-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
